...
color 6F
echo               选择
echo 1.机房工具(停用)  2.云电脑工具 3.娱乐功能  4.开发信息 5.实用功能 6.开发者模式 X.退出
set /p CCMMainActitvyChoice$1=请选择 
...
set /p CCMMainActitvyChoice$2=请选择 
...
set /p CCMMainActitvyChoice$3=请选择 
...
echo               选择
echo 1.小游戏  X.返回主页
set /p CCMMainActitvyChoice$4=请选择 
...
set /p CCMMainActitvyChoice$5=请选择 
...
set /p CCMMainActitvyChoice$6=请选择 
...
title 接口调用器
cls
echo 警告!您已进入开发者模式!对于使用本模式造成的一切软硬件损坏及损失我方均不负责
set /p jiekou=请输入要调用的接口 	若不输入将默认进入上一次调用的接口 
goto %jiekou%